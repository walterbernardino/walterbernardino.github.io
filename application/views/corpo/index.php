						...
						<div class="owl-slider owl-carousel">
							<div class="item">
								<div class="owl-slider-item">
									<img src="https://picsum.photos/id/1/1920/920" class="img-responsive" alt="portfolio">
									<div class="intro-text">
										<div class="intro-lead-in">Criarte</div>
							...
							<div class="item">
								<div class="owl-slider-item">
									<img src="https://picsum.photos/id/1073/1920/920" class="img-responsive" alt="portfolio">
									<div class="intro-text">
							...
							<div class="item">
								<div class="owl-slider-item">
									<img src="https://picsum.photos/id/119/1920/920" class="img-responsive" alt="portfolio">
									<div class="intro-text">
										<div class="intro-lead-in">We are the number one</div>
										<div class="intro-heading"></div>
									</div>
		...
		<section id="portfolio" class="light-bg">
			...
			<div class="row row-0-gutter">
				...
				<div class="col-md-4 col-0-gutter">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?php echo base_url(); ?>public/images/portifolio/1.jpeg" alt="img02" class="img-responsive" />
							<figcaption>
								<h2>Dean & Letter</h2>
								<p>Branding, Design</p>
				...
				<div class="col-md-4 col-0-gutter">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?php echo base_url(); ?>public/images/portifolio/2.jpeg" alt="img02" class="img-responsive" />
							<figcaption>
				...
				<div class="col-md-4 col-0-gutter">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?php echo base_url(); ?>public/images/portifolio/3.jpeg" alt="img02" class="img-responsive" />
							<figcaption>
								<h2>Lamp & Velvet</h2>
								<p>Branding, Web Design</p>
			...
			<div class="row row-0-gutter">
				...
				<div class="col-md-4 col-0-gutter">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?php echo base_url(); ?>public/images/portifolio/4.jpeg" alt="img02" class="img-responsive" />
							<figcaption>
								<h2>Smart Name</h2>
								<p>Branding, Design</p>
				...
				<div class="col-md-4 col-0-gutter">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?php echo base_url(); ?>public/images/portifolio/5.jpeg" alt="img02" class="img-responsive" />
							<figcaption>
								<h2>Fast People</h2>
								<p>Branding, Web Design</p>
				...
				<div class="col-md-4 col-0-gutter">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?php echo base_url(); ?>public/images/portifolio/6.jpeg" alt="img02" class="img-responsive" />
							<figcaption>
								<h2>Kites & Stars</h2>
								<p>Branding, Web Design</p>
		...
		<section class="overlay-dark bg-img1 dark-bg short-section">
			<div class="container text-center">
				<div class="row">
					<div class="col-md-3 mb-sm-30">
						<div class="counter-item">
							<a href="https://www.linkedin.com/in/walter-bernardino-jr-017a53184/" target="blank">
							<img src="<?php echo base_url(); ?>public/images/icones/linkedin.png" alt="">
							<h6>Linkedin</h6>
						</a>
						</div>
					</div>
					<div class="col-md-3 mb-sm-30">
						<div class="counter-item">
							<a href="https://www.instagram.com/criartepersonaliza_/" target="blank">
							<img src="<?php echo base_url(); ?>public/images/icones/insta.png" alt="">
							<h6>Instagram</h6>
						</a>
						</div>
					</div>
					<div class="col-md-3 mb-sm-30">
						<div class="counter-item">
							<a href="https://api.whatsapp.com/send?phone=5588981121069" target="blank">
							<img src="<?php echo base_url(); ?>public/images/icones/whats.png" alt="">
							<h6>Whatsapp</h6>
							</a>
						</div>
					</div>
					<div class="col-md-3 mb-sm-30">
						<div class="counter-item">
							<a href="mailto:wjunior.ber@gmail.com" target="blank">
							<img src="<?php echo base_url(); ?>public/images/icones/gmail.png" alt="">
							<h6>Gmail</h6>
							</a>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							...
							<p>Nossas formas de pagamentos</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="owl-partners owl-carousel">
							<div class="item">
								<div class="partner-logo"><img src="<?php echo base_url(); ?>public/images/demo/1.png" alt="partners"></div>
							</div>
							<div class="item">
							...
							<div class="item">
								<div class="partner-logo"><img src="<?php echo base_url(); ?>public/images/demo/partners-8.png" alt="partners"></div>
							</div>
							<div class="item">
								<div class="partner-logo"><img src="<?php echo base_url(); ?>public/images/demo/partners-9.png" alt="partners"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="<?php echo base_url(); ?>public/images/portifolio/1.jpeg" alt="img01" class="img-responsive" />
		...
		<div class="modal fade" id="Modal-2" tabindex="-1" role="dialog" aria-labelledby="Modal-label-2">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="<?php echo base_url(); ?>public/images/portifolio/2.jpeg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="Modal-3" tabindex="-1" role="dialog" aria-labelledby="Modal-label-3">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="<?php echo base_url(); ?>public/images/portifolio/3.jpeg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="Modal-4" tabindex="-1" role="dialog" aria-labelledby="Modal-label-4">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="<?php echo base_url(); ?>public/images/portifolio/4.jpeg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="Modal-5" tabindex="-1" role="dialog" aria-labelledby="Modal-label-5">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="<?php echo base_url(); ?>public/images/portifolio/5.jpeg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="Modal-6" tabindex="-1" role="dialog" aria-labelledby="Modal-label-6">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="Modal-label-6">Teste</h4>
					</div>
					<div class="modal-body">
						<img src="<?php echo base_url(); ?>public/images/portifolio/5.jpeg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
